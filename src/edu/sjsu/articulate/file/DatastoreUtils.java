...
public class DatastoreUtils {
	...
	public static int insertGoogleFile(String fileId, String fileOwner, String fileName, 
			String contentType, String message, InputStream fileStream) throws IOException {
		int fileSize = -1;
		...
		if (isAllowed) {
	    	...
	    	fileSize = insertGoogleFile(fileId, fileOwner, fileName, contentType, message, googleUnits);
		}
		return fileSize;
	}
	...
	private static int insertGoogleFile(String fileId, String fileOwner, String fileName, 
		...
		GoogleFile entity = new GoogleFile(fileId, fileOwner, fileName, fileSize, contentType, message, googleUnits);
		PersistenceManager pm = PMF.get().getPersistenceManager();
